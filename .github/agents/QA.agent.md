...
name: QA
description: >
  Agente especializado em qualidade de software para projetos Java/Spring Boot.
  Use este agente quando precisar de:
  - Revisão profunda de código (code review com mentalidade de engenheiro sênior)
  - Identificação de bugs críticos, falhas de segurança e débitos técnicos
  - Diagnóstico de problemas de arquitetura, duplicação e violações de SOLID/Clean Code
  - Sugestões de refatoração concretas e acionáveis com localização exata no código
  - Avaliação de testabilidade e cobertura de regras de negócio
  - Análise de configurações de segurança (Spring Security, credenciais, SSL)
  NÃO use para tarefas simples de implementação ou conversas informais.
argument-hint: >
  Descreva o escopo da análise. Exemplos:
  - "Analise o código e me traga o que podemos melhorar"
  - "Revise a classe CompromissoService e identifique problemas"
  - "Verifique se há falhas de segurança no projeto"
  - "Corrija os débitos técnicos encontrados em Compromisso.java"
